...
--
-- Host: localhost    Database: bancofinal
-- ------------------------------------------------------
...
elseif NEW.cantidad>0 then
	update cuentaBancarias set saldo=saldo+new.cantidad where idCliente=auxid;
elseif NEW.cantidad<0 then
	update cuentaBancarias set saldo=saldo+new.cantidad where idCliente=auxid;
end if;
END */;;
...
INSERT INTO `pagos` VALUES (1,'2023-05-25',2000.00,'3','3',63);
...
declare auxPrestamo varchar(45);
declare auxCliente varchar(50);
set auxCliente=New.idCliente;
set auxPrestamo=New.idPrestamo;
set aux=New.cantidadPagada;

update prestamos set cantidadAPagar=cantidadAPagar-aux where idCliente=auxCliente and idPrestamo=auxPrestamo;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
INSERT INTO `prestamos` VALUES ('1','preconcedido','Préstamo personal','2023-01-01',5000.00,12,8.50,365,NULL,NULL,'1',NULL),('2','preconcedido','Préstamo hipotecario','2023-02-01',10000.00,240,6.50,365,NULL,NULL,'2',NULL),('3','concedido','Préstamo automotriz','2023-03-01',15000.00,60,7.20,365,'2023-03-20',2000.00,'3',22000.00),('4','concedido','Préstamo estudiantil','2023-04-01',5000.00,36,5.50,365,'2023-04-25',750.00,'4',9000.00),('5','preconcedido','Préstamo empresarial','2023-05-01',15000.00,120,9.00,365,NULL,NULL,'5',NULL);
...
select nombre into aux1 from clientes where UID=New.idCliente;
if new.estado="concedido" then
insert into movimientos(idCliente,cantidad,concepto,emisor,receptor,fechaMov) values(New.idCliente,New.cantidadConceder,"ingresos",aux1,"banco",curdate());
end if;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
--
-- Dumping events for database 'bancofinal'
--

--
-- Dumping routines for database 'bancofinal'
--
...
-- Dump completed on 2023-05-25 19:54:47
